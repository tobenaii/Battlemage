...
namespace Battlemage.PlayerController
{
    ...
    public partial struct FirstPersonPlayerVariableStepControlSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            state.RequireForUpdate(SystemAPI.QueryBuilder().WithAll<PlayerController, PlayerCharacterInputs>().Build());
        }
        ...
        public partial struct FirstPersonPlayerVariableStepControlJob : IJobEntity
        {
            ...
            void Execute(in DynamicBuffer<InputBufferData<PlayerCharacterInputs>> playerCommandsBuffer, in PlayerCharacterInputs playerCommands, in PlayerController character)
            {
    ...
    public partial struct FirstPersonPlayerFixedStepControlSystem : ISystem
    {
        ...
        public partial struct FirstPersonPlayerFixedStepControlJob : IJobEntity
        {
            ...
            void Execute(in PlayerCharacterInputs playerCommands, in PlayerController player)
            {
