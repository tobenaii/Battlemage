    ...
    public class PathUtils
    {
            ...
            , int maxStraightPath)
        {
            for (var k = startIndex; k < endIndex - 1; ++k)
            {
                ...
                SegmentSegmentCPA(out var cpa1, l, r, straightPath[n - 1].position, termPos);
        ...
        private static void SegmentSegmentCPA(out float3 c0, float3 p0, float3 p1, float3 q0, float3 q1)
        {
            var u = p1 - p0;
            var v = q1 - q0;
            var w0 = p0 - q0;
